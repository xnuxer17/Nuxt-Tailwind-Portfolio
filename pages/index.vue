<template>
  <div>
    <img
      class="fixed  left-0 w-full h-full object-cover"
      src="https://images.unsplash.com/photo-1566837945700-30057527ade0?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=750&q=80"
    />
    <div
      class="h-screen relative flex items-center justify-center bg-blue-500 opacity-75 fixed"
    >
      <div class="flex lg:w-8/12 w-10/12 flex-col md:flex-row">
        <img
          class="w-56 h-56 rounded-full mb-8 md:mb-0"
          src="../assets/images/my.jpg"
        />
        <div class="md:ml-16 text-white">
          <h1 class="text-3xl font-bold">M Hafidz Masruri</h1>
          <div class="uppercase tracking-widest font-light text-xs">
            Full Stack Engineer
          </div>
          <p class="mt-4 text-lg leading-relaxed">
            Saya seorang mahasiswa IT di universitas nurul jadid, pekerjaan
            sehari-hari saya adalah ngoding,menulis dan mengajar di ukm dan
            komunitas di kampus
          </p>
          <div class="flex mt-10 items-center">
            <!-- Button -->
            <a
              class="bg-pink-500 text-white rounded px-10 py-3 mr-4 text-center"
              href="#"
            >
              Contact Me
            </a>
            <!-- Facebook -->
            <a href="https://web.facebook.com/hafet.coding/">
              <svg
                class="mx-4"
                width="25"
                height="25"
            ...
            <!-- Twitter -->
            <a href="https://twitter.com/MHafet17">
              <svg
                class="mx-4"
                width="25"
                height="25"
